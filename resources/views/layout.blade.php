...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +0774525140</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> nhphuc1091999@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <?php
                                 ...
                                 ?>
                                 <li><a href="{{URL::to('/logout-checkout')}}"><i class="fa fa-lock"></i> Đăng nhập</a></li>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    <h1><span>PHÚC NGUYỄN</span>-SHOP</h1>
    ...
    <footer id="footer"><!--Footer-->
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2><span>PHÚC NGUYỄN</span>-SHOP</h2>
                    ...
                    <div class="col-sm-3">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="#">HỆ THỐNG ĐƠN HÀNG</a></li>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2021 PHUC NGUYEN-SHOPPER Inc.</p>
                    <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">PHUC NGUYEN</a></span></p>
                </div>
            </div>
        </div>
